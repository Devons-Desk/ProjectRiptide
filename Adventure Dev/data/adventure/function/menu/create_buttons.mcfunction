summon interaction -31.5 59 -38.5 {CustomNameVisible:1b,width:1.05f,height:1.05f,Tags:["menu.button.start","menu.button"],CustomName:'{"text":"Start"}'}
...
summon interaction -33.5 59 -38.5 {CustomNameVisible:1b,width:1.5f,height:1.5f,Tags:["menu.button.credits","menu.button"],CustomName:'{"text":"Credits"}'}
...
summon interaction -29.5 59 -38.5 {CustomNameVisible:1b,width:1.5f,height:1.5f,Tags:["menu.button.settings","menu.button"],CustomName:'{"text":"Settings"}'}
