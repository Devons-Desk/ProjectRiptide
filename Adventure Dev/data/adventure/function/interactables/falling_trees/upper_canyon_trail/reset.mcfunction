...
execute positioned -182 72 393 run summon shulker ~ ~ ~ {Silent:1b,DeathLootTable:"0",NoAI:1b,Health:1000f,AttachFace:0b,Tags:["inter.falling_tree.hitbox","inter.falling_tree.uct","loop.tick"],active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.armor,Base:0}]}
