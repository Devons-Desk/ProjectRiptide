...
execute if entity @s[tag=trap_bees] at @s run data modify entity @s AngryAt set from entity @e[type=#adventure:interactables/bee_attackable,limit=1,sort=nearest,distance=..13] UUID 
