...
execute at @e[tag=inter.padlock.fragile,limit=1,sort=nearest] run summon snowball ^ ^1 ^-0.5 {Silent:1b,Tags:["padlock.fragile.fall"],Item:{id:"minecraft:flint",Count:1b,tag:{CustomModelData:5100009}}}
