ride @s mount @e[type=villager,tag=npc.talkative,sort=nearest,limit=1]
...
tag @e[type=villager,sort=nearest,limit=1,tag=npc.talkative,tag=!npc.display_mounted] add npc.display_mounted
